...
public class DrilldownToolsNotCommunicatingToEquipmentTracking {
	private WebDriver driver;
	  ...
	  public void DrilldownToET() throws InterruptedException {
		  int ToolsNoCommunicating = CorporateDashboard.GetToolsNotCommunicating();
		  Thread.sleep(1000);
		  ...
		  Assert.assertEquals("Total Records:"+ToolsNoCommunicating,EquipmentTrackingCounts);
	  }
